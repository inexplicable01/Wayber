                ...
                <DropdownToggle tag="button" type="button" className="btn">
                    <span className="d-flex align-items-center">
                        ...
                        <span className="text-start ms-xl-2">
                            ...
                            <span
                                className="d-none d-xl-block ms-1 fs-13 text-muted user-name-sub-text">{user ? `${user.email}` : 'Guest'}</span>
                        </span>
                    </span>
                </DropdownToggle>
                <DropdownMenu className="dropdown-menu-end">

                    <h6 className="dropdown-header">Welcome {user ? `${user.first_name} ${user.last_name}` : 'Guest'}!</h6>
