...
const FormWizard = () => {
  document.title = "Wizard | Wayber - " + process.env.APPNAME_TITLE;
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <Form action="Template/Forms/FormWizard#" className="form-steps" autoComplete="off">
                          ...
                          <div className="text-center">
                            <div className="mb-4">
                              <lord-icon
                                ...
                                trigger="loop"
                                colors="primary:#02a8b5,secondary:#405189"
