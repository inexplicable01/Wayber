...
import { getUserDeviceChartsData } from "../../../store/BackUp/dashboardAnalytics/action";
        ...
        <React.Fragment>
            <Col xl={4}>
                <Card className="card-height-100">
                    ...
                    <CardBody>
                        <div dir="ltr">
                            <UsersByDeviceCharts series={chartData} dataColors='["--vz-primary", "--vz-secondary", "--vz-warning"]' />
                        </div>
