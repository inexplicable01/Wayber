...
const EcommerceAddProduct = (props) => {
  document.title = "Create Product | Wayber - React Admin & Dashboard Template";
                      ...
                      <div className="position-relative d-inline-block">
                        ...
                        <div className="avatar-lg">
                          <div className="avatar-title bg-light rounded">
                            <img src="Template/Ecommerce/EcommerceProducts" id="product-img" alt="" className="avatar-md h-auto" />
                          </div>
                        </div>
                      </div>
                    </div>
