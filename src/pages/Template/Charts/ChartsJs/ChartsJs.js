...
const PieChart = ({dataColors}) => { 
  ...
  return (
    <React.Fragment>
      <Pie className="chartjs-chart" data={data} options={option} />
    </React.Fragment>
  )
}
...
const DonutChart = ({dataColors}) => {  
  ...
  return (
    <React.Fragment>
      <Doughnut className="chartjs-chart" data={data} options={option} />
    </React.Fragment>
  )
}
...
const PolarChart = ({dataColors}) => {  
  ...
  return (
    <React.Fragment>
      <Polar className="chartjs-chart" data={data} options={option} />
    </React.Fragment>
  )
}
