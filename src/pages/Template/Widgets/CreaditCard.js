                        ...
                        <CardBody>
                            ...
                            <form id="custom-card-form" autoComplete="off">
                                <div className="mb-3">
                                    ...
                                    <input id="card-num-input" className="form-control" maxLength="16" placeholder="0000 0000 0000 0000" />
                                </div>
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            ...
                            <div className="form-container active">
                                <form action="Template/Widgets" id="card-form-elem" autoComplete="off">
                                    <div className="mb-3">
                                        <label htmlFor="card-number-input" className="form-label">Card Number</label>
                                        <input className="form-control" placeholder="Card number" type="tel" id="card-number-input" />
                                    </div>
                                    <div className="mb-3">
                                        <label htmlFor="card-name-input" className="form-label">Card Holder</label>
                                        <input className="form-control" placeholder="Full name" type="text" id="card-name-input" />
                                    </div>
                                    <Row>
                                        <Col sm={6}>
                                            <div className="mb-3">
                                                <label htmlFor="card-expiry-input" className="form-label">Expiry</label>
                                                <input className="form-control" placeholder="MM/YY" type="tel" id="card-expiry-input" />
                                            </div>
                                        </Col>
                                        <Col sm={6}>
                                            <div className="mb-3">
                                                <label htmlFor="card-cvc-input" className="form-label">CVC</label>
                                                <input className="form-control" placeholder="CVC" type="number" id="card-cvc-input" />
                                            </div>
                                        </Col>
                                    </Row>
