...
const Navdata = () => {
    ...
    const [isProjectgroups, setIsProjectgroups] = useState(false);
    ...
    useEffect(() => {
        ...
        if (iscurrentState !== 'projectgroup') {
            setIsProjectgroups(false);
        }
    ...
    const menuItems = [
        ...
        // },
        {
            ...
            click: function (e) {
                e.preventDefault();
                setIsProjectgroups(!isProjectgroups);
                setIscurrentState('projectgroup');
                updateIconSidebar(e);
            },
            stateVariables: isProjectgroups,
            subItems: [
                // {
                //     id: "calendar",
                //     label: "Calendar",
            ...
            subItems: [
                ...
                },
                {
                    ...
                    parentId: "nwmls_forms",
                                ...
                                {
                    id: "form_21ad",
                    label: "Form 22AD Increased Down Payment",
                    link: "/form_21ad",
                    parentId: "nwmls_forms",
                },
...
// {
        ...
        //         { id: "PrivecyPolicy", label: "Privecy Policy", link: "/pages-privecy-policy", parentId: "pages", badgeName: "New", badgeColor: "success" },
        //         { id: "TermsCondition", label: "Terms Condition", link: "/pages-terms-condition", parentId: "pages", badgeName: "New", badgeColor: "success" },
        //     ],
        // },
